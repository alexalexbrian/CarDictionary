                ...
                <ul class="media-list p-t-md">
                    ...
                    <li class="media m-t-0" id="edicion_termino" style="display: none;">
                        <div class="media-body" style="border-right: 1px solid #edeef3; padding-right: 15px;">
                                ...
                                <div class="note-editor panel panel-default">
                                    ...
                                    <div class="note-toolbar panel-heading">
                                        <div class="note-style btn-group"><button type="button"
                                                ...
                                                class="btn btn-default btn-sm" title="" data-event="italic"
                                                tabindex="-1" data-name="italic"
                                                data-original-title="Italic (CTRL+I)"><i
                                                    class="fa fa-italic"></i></button><button type="button"
                                                class="btn btn-default btn-sm" title="" data-event="underline"
                                                tabindex="-1" data-name="underline"
                                        ...
                                        <div class="note-font btn-group"><button type="button"
                                                ...
                                                tabindex="-1" data-name="superscript"
                                                data-original-title="Superscript"><i
                                                    class="fa fa-superscript"></i></button><button type="button"
                                                class="btn btn-default btn-sm" title="" data-event="subscript"
                                                tabindex="-1" data-name="subscript" data-original-title="Subscript"><i
                                                    class="fa fa-subscript"></i></button></div>
                                        <div class="note-color btn-group"><button type="button"
                                                class="btn btn-default btn-sm note-recent-color" title=""
                                                data-event="color"
                                                data-value="{&quot;backColor&quot;:&quot;yellow&quot;}" tabindex="-1"
                                                data-name="color" data-original-title="Recent Color"><i
                                                    class="fa fa-font"
                                        ...
                                        <div class="note-view btn-group"><button type="button"
                                                class="btn btn-default btn-sm" title="" data-event="codeview"
                                                tabindex="-1" data-name="codeview" data-original-title="Code View"><i
                                        ...
                                        <div class="note-popover">
                                            ...
                                            <div class="note-image-popover popover bottom in" style="display: none;">
                                                ...
                                                <div class="popover-content">
                                                    ...
                                                    <div class="btn-group"><button type="button"
                                                            class="btn btn-default btn-sm" title=""
                                                            data-event="imageShape" data-value="img-rounded"
                                                            tabindex="-1" data-original-title="Shape: Rounded"><i
                                                                class="fa fa-square"></i></button><button type="button"
                                                            class="btn btn-default btn-sm" title=""
                                                            data-event="imageShape" data-value="img-circle"
                                                            tabindex="-1" data-original-title="Shape: Circle"><i
                                                                class="fa fa-circle-o"></i></button><button
                                                            type="button" class="btn btn-default btn-sm" title=""
                                                            data-event="imageShape" data-value="img-thumbnail"
                                                            tabindex="-1" data-original-title="Shape: Thumbnail"><i
                                                                class="fa fa-picture-o"></i></button><button
                                                            type="button" class="btn btn-default btn-sm" title=""
                                                            data-event="imageShape" tabindex="-1"
                            ...
                            <div class="form-group">
                                <label for="descripcion_termino"
                                    class="termino-principal-tit termino-tit initialism">Estado </label>
                                <select class="form-control form-control-sm" id="estado"
                                    name="estado_termino_principal">
                            ...
                            <div class="media-right" style="padding: 0px;">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <a href="#" class="btn btn-term btn-nuevo" data-toggle="modal"
                                        data-target="#modalNuevoTerminoRelacionadoVid"><i
                                            class="icon-circle-plus"></i></a>
                                </div>
                            </div>
                        </li><!-- /.media -->
                        <!-- /titular -->
                        ...
                        <li class="media">
                            ...
                            <div class="media-right" style="padding: 0px; min-width: 55px!important">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <!-- <a href="" class="btn btn-term btn-edit"><i class="fa fa-pencil"></i></a> -->
                                    <a href="#" class="btn btn-term btn-nuevo" data-toggle="modal"
                                        data-target="#modalNuevoTerminoRelacionadoEn"><i
                                            class="icon-circle-plus"></i></a>
                                </div>
                            </div>
                        </li><!-- /.media -->
                    ...
                    <ul class="media-list">
                        ...
                        <li class="media">
                            ...
                            <div class="media-right" style="padding: 0px; min-width: 55px!important">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="#" class="btn btn-term btn-nuevo" data-toggle="modal"
                                        data-target="#modalNuevoTerminoRelacionadoEnEs"><i
                                            class="icon-circle-plus"></i></a>
                                </div>
                            </div>
                        </li><!-- /.media -->
                    ...
                    <div class="modal-body">
                        ...
                        <ul class="list-group" style="font-size: 0.85em; line-height: normal">
                            ...
                            <li class="list-group-item">
                                ...
                                hacer clic de nuevo en el botón código <img
                                    src="assets/images/ico_versalita_captura.png" alt="">. Después hacer clic en el
                            ...
                            <li class="list-group-item">
                                ...
                                <br>
                                <em><strong>Frase con versalita:</strong> </em>Lorem ipsum <span
                                    class="versalita">ad</span> his
                            </li>
                        </ul>
